...
// Ensure this page is never pre-rendered
...
export default function AuthCallback() {
  ...
  useEffect(() => {
    ...
    const run = async () => {
      ...
      // Older links with #access_token=... (handled by getSession)
      ...
      setMsg('Still signing you in… If this stays here, open the link in the same browser where the app is running (not an email app’s mini-browser).');
    };
